...
#define LOAD(name, field) nh.param(name, field, field)
  ...
  LOAD("navigation_mode/avoid_enter_distance_m", c.navigation_mode.avoid_enter_distance_m);
  LOAD("navigation_mode/avoid_immediate_distance_m", c.navigation_mode.avoid_immediate_distance_m);
  LOAD("navigation_mode/avoid_block_confirm_sec", c.navigation_mode.avoid_block_confirm_sec);
  LOAD("navigation_mode/local_avoid_min_hold_sec", c.navigation_mode.local_avoid_min_hold_sec);
  LOAD("navigation_mode/route_clear_confirm_sec", c.navigation_mode.route_clear_confirm_sec);
  LOAD("navigation_mode/rejoin_lateral_tolerance_m", c.navigation_mode.rejoin_lateral_tolerance_m);
  LOAD("navigation_mode/rejoin_heading_tolerance_rad", c.navigation_mode.rejoin_heading_tolerance_rad);
  LOAD("navigation_mode/rejoin_confirm_sec", c.navigation_mode.rejoin_confirm_sec);
  ...
  LOAD("trajectory_follower/heading_turn_only_threshold_rad", c.trajectory_follower.heading_turn_only_threshold_rad);
  LOAD("rejoin_target/default_forward_distance_m", c.rejoin_target.default_forward_distance_m);
  LOAD("rejoin_target/min_forward_distance_m", c.rejoin_target.min_forward_distance_m);
  LOAD("rejoin_target/max_forward_distance_m", c.rejoin_target.max_forward_distance_m);
  LOAD("rejoin_target/route_yaw_tolerance_rad", c.rejoin_target.route_yaw_tolerance_rad);
